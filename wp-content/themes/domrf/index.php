...
<main>
			...
			<div class="flex-row popular-projects-list">
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/baderim/"><span>"Бадерим"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>15х13</b></div>
								</div>
				...
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/borgo/"><span>"Борго"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>16х12</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>6</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>216
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>5</b></div>
								</div>
							</div>
							<div class="project-item-features">
								<ul class="project-item-features-list">
									<li class="project-item-feature"><span><svg xmlns="http://www.w3.org/2000/svg"
												...
												<path fill-rule="evenodd" fill="rgb(116, 187, 22)"
													d="M3.500,0.000 C5.433,0.000 7.000,1.567 7.000,3.500 C7.000,5.433 5.433,7.000 3.500,7.000 C1.567,7.000 0.000,5.433 0.000,3.500 C0.000,1.567 1.567,0.000 3.500,0.000 Z" />
											</svg>Тип дома:</span><b>Кирпич</b></li>
									<li class="project-item-feature"><span><svg xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" width="7px" height="7px">
												<path fill-rule="evenodd" fill="rgb(116, 187, 22)"
													d="M3.500,0.000 C5.433,0.000 7.000,1.567 7.000,3.500 C7.000,5.433 5.433,7.000 3.500,7.000 C1.567,7.000 0.000,5.433 0.000,3.500 C0.000,1.567 1.567,0.000 3.500,0.000 Z" />
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>6&nbsp;912&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/borgo/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/glyasse/"><span>"Гляссе"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>185
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-features">
								<ul class="project-item-features-list">
									<li class="project-item-feature"><span><svg xmlns="http://www.w3.org/2000/svg"
												...
												<path fill-rule="evenodd" fill="rgb(116, 187, 22)"
													d="M3.500,0.000 C5.433,0.000 7.000,1.567 7.000,3.500 C7.000,5.433 5.433,7.000 3.500,7.000 C1.567,7.000 0.000,5.433 0.000,3.500 C0.000,1.567 1.567,0.000 3.500,0.000 Z" />
											</svg>Тип дома:</span><b>Газобетон</b></li>
									<li class="project-item-feature"><span><svg xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" width="7px" height="7px">
												<path fill-rule="evenodd" fill="rgb(116, 187, 22)"
													d="M3.500,0.000 C5.433,0.000 7.000,1.567 7.000,3.500 C7.000,5.433 5.433,7.000 3.500,7.000 C1.567,7.000 0.000,5.433 0.000,3.500 C0.000,1.567 1.567,0.000 3.500,0.000 Z" />
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;550&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/glyasse/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/everett/"><span>"Эверетт"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>10х10</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>174
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
								</div>
							</div>
							<div class="project-item-features">
								<ul class="project-item-features-list">
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;220&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/everett/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/luronium/"><span>"Лурониум"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>9х6</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>6</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>137
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-features">
								<ul class="project-item-features-list">
									<li class="project-item-feature"><span><svg xmlns="http://www.w3.org/2000/svg"
												...
												<path fill-rule="evenodd" fill="rgb(116, 187, 22)"
													d="M3.500,0.000 C5.433,0.000 7.000,1.567 7.000,3.500 C7.000,5.433 5.433,7.000 3.500,7.000 C1.567,7.000 0.000,5.433 0.000,3.500 C0.000,1.567 1.567,0.000 3.500,0.000 Z" />
											</svg>Тип дома:</span><b>Дерево</b></li>
									<li class="project-item-feature"><span><svg xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" width="7px" height="7px">
												<path fill-rule="evenodd" fill="rgb(116, 187, 22)"
													d="M3.500,0.000 C5.433,0.000 7.000,1.567 7.000,3.500 C7.000,5.433 5.433,7.000 3.500,7.000 C1.567,7.000 0.000,5.433 0.000,3.500 C0.000,1.567 1.567,0.000 3.500,0.000 Z" />
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>3&nbsp;904&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/luronium/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/proksima/"><span>"Проксима"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>11х11</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>187
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>2</b></div>
								</div>
							</div>
							<div class="project-item-features">
								<ul class="project-item-features-list">
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;610&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/proksima/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/sidnej/"><span>"Сидней"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>125
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;200&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/sidnej/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/siti/"><span>"Сити"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>84
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>2&nbsp;755&nbsp;200</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/siti/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a
									href="/proekty/gorodishhe/"><span>"Городище"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>20х9</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>237
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>7&nbsp;584&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/gorodishhe/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/protoka/"><span>"Протока"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>9х12</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>155
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;952&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/protoka/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/majya/"><span>"Майя"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>10х11</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>180
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-features">
								<ul class="project-item-features-list">
									<li class="project-item-feature"><span><svg xmlns="http://www.w3.org/2000/svg"
												...
												<path fill-rule="evenodd" fill="rgb(116, 187, 22)"
													d="M3.500,0.000 C5.433,0.000 7.000,1.567 7.000,3.500 C7.000,5.433 5.433,7.000 3.500,7.000 C1.567,7.000 0.000,5.433 0.000,3.500 C0.000,1.567 1.567,0.000 3.500,0.000 Z" />
											</svg>Тип дома:</span><b>Каркасный</b></li>
									<li class="project-item-feature"><span><svg xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" width="7px" height="7px">
												<path fill-rule="evenodd" fill="rgb(116, 187, 22)"
													d="M3.500,0.000 C5.433,0.000 7.000,1.567 7.000,3.500 C7.000,5.433 5.433,7.000 3.500,7.000 C1.567,7.000 0.000,5.433 0.000,3.500 C0.000,1.567 1.567,0.000 3.500,0.000 Z" />
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;716&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/majya/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/uprava/"><span>"Управа"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>11х10</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;400&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/uprava/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/teremok/"><span>"Теремок"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>145
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;103&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/teremok/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/frida/"><span>"Фрида"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>12х7</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;452&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/frida/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/letnyaya/"><span>"Летняя"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>16х10</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>196
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>7&nbsp;526&nbsp;400</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/letnyaya/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a
									href="/proekty/berezhnyj/"><span>"Бережный"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>7х7</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>2</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>83
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>1</b></div>
								</div>
							</div>
							<div class="project-item-features">
								<ul class="project-item-features-list">
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>2&nbsp;714&nbsp;100</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/berezhnyj/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a
									href="/proekty/goloczena/"><span>"Голоцена"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>16х9</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>6</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>200
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>5</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>6&nbsp;400&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/goloczena/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/belaya/"><span>"Белая"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>16х12</b></div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>132
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;491&nbsp;200</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/belaya/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/maksim/"><span>"Максим"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>20х15</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>308
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>9&nbsp;856&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/maksim/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a
									href="/proekty/polushkino/"><span>"Полушкино"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>9х11</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>128
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;324&nbsp;800</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/polushkino/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/siren/"><span>"Сирень"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>19х14</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>7</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>271
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>6</b></div>
								</div>
							</div>
							<div class="project-item-features">
								<ul class="project-item-features-list">
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>8&nbsp;672&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/siren/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a
									href="/proekty/kingisepp/"><span>"Кингисепп"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>21х19</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>6</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>176
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>5</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;280&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/kingisepp/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/fortsmit/"><span>"Фортсмит"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>15х15</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>226
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;650&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/fortsmit/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a
									href="/proekty/tradiczii/"><span>"Традиции"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;380&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/tradiczii/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/klassik/"><span>"Классик"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>10х10</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;734&nbsp;400</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/klassik/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/vorozheya/"><span>"Ворожея"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>9х6</b></div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>135
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;387&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/vorozheya/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a
									href="/proekty/solnechnyj/"><span>"Солнечный"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>11х7</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>3</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>82
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>2</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>2&nbsp;689&nbsp;600</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/solnechnyj/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/emo/"><span>"Эмо"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>14х14</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>149
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;246&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/emo/" class="project-item-btn"><span class="orange-link">Посмотреть
								проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a
									href="/proekty/prioritet/"><span>"Приоритет"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>13х7</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>6</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>166
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>5</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;465&nbsp;400</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/prioritet/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/ispolin/"><span>"Исполин"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>13х10</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>116
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>3&nbsp;804&nbsp;800</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/ispolin/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/erika/"><span>"Эрика"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>156
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>6</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;196&nbsp;400</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/erika/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/ohta/"><span>"Охта"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>8х11</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>89
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>3&nbsp;337&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/ohta/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/demetra/"><span>"Деметра"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>10х8</b></div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>158
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;740&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/demetra/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/solonka/"><span>"Солонка"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>15х11</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;680&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/solonka/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a
									href="/proekty/karambola/"><span>"Карамбола"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>10х10</b></div>
								</div>
						...
						</div> <a href="/proekty/karambola/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/pinsk/"><span>"Пинск"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>12х8</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>2&nbsp;919&nbsp;200</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/pinsk/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/zhasmin/"><span>"Жасмин"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>79
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>2</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>2&nbsp;962&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/zhasmin/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/korytovo/"><span>"Корытово"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>13х10</b></div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>134
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;355&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/korytovo/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/izhma/"><span>"Ижма"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>11х8</b></div>
								</div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>139
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;517&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/izhma/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/ornella/"><span>"Орнелла"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>10х7</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>107
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;012&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/ornella/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/kreod/"><span>"Креод"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>7х15</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
						...
						</div> <a href="/proekty/kreod/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/valma/"><span>"Вальма"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>19х17</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>6</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>279
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>5</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>6&nbsp;110&nbsp;100</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/valma/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/udachnyj/"><span>"Удачный"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>12х8</b></div>
						...
						</div> <a href="/proekty/udachnyj/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/eridan/"><span>"Эридан"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>9х9</b></div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>114
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>3&nbsp;739&nbsp;200</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/eridan/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/orenburg/"><span>"Оренбург"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>10х14</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>4</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>186
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;580&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/orenburg/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/mini/"><span>"Мини"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>92
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>3</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>3&nbsp;008&nbsp;400</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/mini/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/loshhina/"><span>"Лощина"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>11х8</b></div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>208
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>4&nbsp;534&nbsp;400</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/loshhina/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/primula/"><span>"Примула"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>17х17</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>6</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>173
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>5</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>5&nbsp;190&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/primula/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/brandon/"><span>"Брандон"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>10х9</b></div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>85
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>2</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>2&nbsp;779&nbsp;500</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/brandon/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/hamilton/"><span>"Хамилтон"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>51
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>2</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>1&nbsp;887&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/hamilton/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/andriya/"><span>"Андрия"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>12х9</b></div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>109
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>3&nbsp;575&nbsp;200</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/andriya/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/villedzh/"><span>"Виллэдж"</span></a>
							</div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>10х9</b></div>
								...
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>103
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>3&nbsp;368&nbsp;100</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/villedzh/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-wrapper">
					<div class="project-item default-hide-mobile">
						...
						<div class="project-item-content">
							<div class="project-item-title"><a href="/proekty/ameli/"><span>"Амели"</span></a></div>
							<div class="project-item-attrs">
								<div class="project-item-attr project-item-attr-size">
									<div class="project-item-attr-text"> <span>Размеры:</span> <b>15х9</b></div>
								</div>
								<div class="project-item-attr project-item-attr-rooms">
									<div class="project-item-attr-text"> <span>Комнат:</span> <b>5</b></div>
								</div>
								<div class="project-item-attr project-item-attr-area">
									<div class="project-item-attr-text"> <span>Площадь:</span> <b>120
											м<sup>2</sup></b></div>
								</div>
								<div class="project-item-attr project-item-attr-bedrooms">
									<div class="project-item-attr-text"> <span>Спален:</span> <b>4</b></div>
							...
							<div class="project-item-price single-price-box">
								<div class="single-price-value">
									Стоимость&nbsp;от<br><span>3&nbsp;396&nbsp;000</span>&nbsp;руб</div>
							</div>
						</div> <a href="/proekty/ameli/" class="project-item-btn"><span
								class="orange-link">Посмотреть проект</span></a>
					</div>
				</div>
				<div class="project-item-last-wrapper">
					<div class="project-last">
						<div class="project-last-content lazyload"
							...
							<div class="project-last-pluses">
								<div class="project-last-plus-item">
									<div class="project-last-plus-item-title"><span
											style="margin-right:3px;">Топ</span> 50</div>
									<div class="project-last-plus-item-value">Самых популярных <br>проектов домов
									</div>
								</div>
								<div class="project-last-plus-item">
									<div class="project-last-plus-item-title">100%</div>
									<div class="project-last-plus-item-value">Найдётся <br>хороший вариант</div>
								</div>
								<form class="project-last-form" method="POST" action="javascript:void(0)">
									<div class="form-group-socials">
										<div class="form-group-title text-center">Куда отправить подборку?</div>
										<div class="form-group form-group-socials-labels"> <input type="radio"
										...
										<div class="form-group">
											<div class="text-center"> <label class="form-label"
													for="phone-project-last-0">Введите телефон</label></div> <input
												type="tel" name="phone" id="phone-project-last-0"
												class="form-control" placeholder="+7" required>
										</div>
										<div class="form-group"> <input type="text" name="your-name"
												id="your-name-project-last-0" class="form-control"
												placeholder="Ваше имя"></div>
										<div class="form-group submit-group"> <button type="submit"
												class="button orange project-last-button lazyload">Получить каталог
												проектов</button> <input type="hidden" name="form_id"
												value="catalog-top"></div>
										<div class="form-group privacy-group">Нажимая на кнопку вы соглашаетесь с
											условиями <span onclick="window.open('/privacy-policy/')">Политики
												конфиденциальности</span></div>
									</div>
				...
				<div class="text-center load-more-link-wrapper"> <a href="/proekty/"
						class="load-more-link"><span>Показать ещё</span></a></div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="instagram-box lazyload" data-bg="<?php echo get_template_directory_uri(); ?>/assets/superuploads/2021/05/insta-bg.jpg"
				...
				<div class="instagram-box-icon"> <noscript><img
						...
						src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E'
						data-src="wp-content/themes/super_dom/images/insta-big.png"></div>
		...
		<div class="container">
			...
			<div class="swiper-container steps-slider">
				...
				<div class="swiper-slide six-steps-tab-content active">
					<div class="step-item">
						<div class="step-item-image"> <noscript><img width="1024" height="683"
								...
								alt="Согласовываем с вами все предварительные вопросы"
								title="Согласовываем с вами все предварительные вопросы"
								data-srcset="superuploads/2021/07/image-35-1024x683.png 1024w, /superuploads/2021/07/image-35-300x200.png 300w, /superuploads/2021/07/image-35-768x512.png 768w, /superuploads/2021/07/image-35-1536x1024.png 1536w, /superuploads/2021/07/image-35.png 1800w"
				...
				<div class="swiper-slide six-steps-tab-content">
					<div class="step-item">
						<div class="step-item-image"> <noscript><img width="1024" height="683"
									src="/superuploads/2021/07/image-36-1024x683.png"
									class="attachment-large size-large"
									...
									srcset="/superuploads/2021/07/image-36-1024x683.png 1024w, /superuploads/2021/07/image-36-300x200.png 300w, /superuploads/2021/07/image-36-768x512.png 768w, /superuploads/2021/07/image-36.png 1200w"
									sizes="(max-width: 1024px) 100vw, 1024px" /></noscript><img width="1024"
								height="683"
								src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%201024%20683%22%3E%3C/svg%3E'
								data-src="/superuploads/2021/07/image-36-1024x683.png"
								class="lazyload attachment-large size-large"
								alt="Если нужен проект, выбираем из типовых или разрабатываем индивидуальный"
								title="Если нужен проект, выбираем из типовых или разрабатываем индивидуальный"
								data-srcset="/superuploads/2021/07/image-36-1024x683.png 1024w, /superuploads/2021/07/image-36-300x200.png 300w, /superuploads/2021/07/image-36-768x512.png 768w, /superuploads/2021/07/image-36.png 1200w"
								data-sizes="(max-width: 1024px) 100vw, 1024px" /></div>
						<div class="step-item-content">
							<div class="step-item-before-title">
				...
				<div class="swiper-slide six-steps-tab-content">
					<div class="step-item">
						<div class="step-item-image"> <noscript><img width="1024" height="504"
									src="/superuploads/2021/07/image-37-1024x504.png"
									class="attachment-large size-large"
									alt="Заливка фундамента. Начало строительства"
									title="Заливка фундамента. Начало строительства"
									srcset="/superuploads/2021/07/image-37-1024x504.png 1024w, /superuploads/2021/07/image-37-300x148.png 300w, /superuploads/2021/07/image-37-768x378.png 768w, /superuploads/2021/07/image-37.png 1170w"
									sizes="(max-width: 1024px) 100vw, 1024px" /></noscript><img width="1024"
								height="504"
								src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%201024%20504%22%3E%3C/svg%3E'
								data-src="/superuploads/2021/07/image-37-1024x504.png"
								class="lazyload attachment-large size-large"
								alt="Заливка фундамента. Начало строительства"
								title="Заливка фундамента. Начало строительства"
								data-srcset="/superuploads/2021/07/image-37-1024x504.png 1024w, /superuploads/2021/07/image-37-300x148.png 300w, /superuploads/2021/07/image-37-768x378.png 768w, /superuploads/2021/07/image-37.png 1170w"
								data-sizes="(max-width: 1024px) 100vw, 1024px" /></div>
						<div class="step-item-content">
							<div class="step-item-before-title">
				...
				<div class="swiper-slide six-steps-tab-content">
					<div class="step-item">
						<div class="step-item-image"> <noscript><img width="1024" height="683"
									src="/superuploads/2021/07/cellenbeton-1-1024x683.png"
									class="attachment-large size-large" alt="Возведение стен"
									title="Возведение стен"
									srcset="/superuploads/2021/07/cellenbeton-1-1024x683.png 1024w, /superuploads/2021/07/cellenbeton-1-300x200.png 300w, /superuploads/2021/07/cellenbeton-1-768x512.png 768w, /superuploads/2021/07/cellenbeton-1-1536x1024.png 1536w, /superuploads/2021/07/cellenbeton-1-2048x1365.png 2048w"
									sizes="(max-width: 1024px) 100vw, 1024px" /></noscript><img width="1024"
								height="683"
								src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%201024%20683%22%3E%3C/svg%3E'
								data-src="/superuploads/2021/07/cellenbeton-1-1024x683.png"
								class="lazyload attachment-large size-large" alt="Возведение стен"
								title="Возведение стен"
								data-srcset="/superuploads/2021/07/cellenbeton-1-1024x683.png 1024w, /superuploads/2021/07/cellenbeton-1-300x200.png 300w, /superuploads/2021/07/cellenbeton-1-768x512.png 768w, /superuploads/2021/07/cellenbeton-1-1536x1024.png 1536w, /superuploads/2021/07/cellenbeton-1-2048x1365.png 2048w"
								data-sizes="(max-width: 1024px) 100vw, 1024px" /></div>
						<div class="step-item-content">
							<div class="step-item-before-title">
				...
				<div class="swiper-slide six-steps-tab-content">
					<div class="step-item">
						<div class="step-item-image"> <noscript><img width="751" height="500"
									src="/superuploads/2021/05/step5.png" class="attachment-large size-large"
									alt="Установка крыши" title="Установка крыши"
									srcset="/superuploads/2021/05/step5.png 751w, /superuploads/2021/05/step5-300x200.png 300w"
								...
								data-src="/superuploads/2021/05/step5.png"
								class="lazyload attachment-large size-large" alt="Установка крыши"
								title="Установка крыши"
								data-srcset="/superuploads/2021/05/step5.png 751w, /superuploads/2021/05/step5-300x200.png 300w"
				...
				<div class="swiper-slide six-steps-tab-content">
					<div class="step-item">
						<div class="step-item-image"> <noscript><img width="751" height="500"
									src="/superuploads/2021/05/step6.png" class="attachment-large size-large"
									alt="Внешняя отделка" title="Внешняя отделка"
									srcset="/superuploads/2021/05/step6.png 751w, /superuploads/2021/05/step6-300x200.png 300w"
									sizes="(max-width: 751px) 100vw, 751px" /></noscript><img width="751"
								height="500"
								src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20751%20500%22%3E%3C/svg%3E'
								data-src="/superuploads/2021/05/step6.png"
								class="lazyload attachment-large size-large" alt="Внешняя отделка"
								title="Внешняя отделка"
								data-srcset="/superuploads/2021/05/step6.png 751w, /superuploads/2021/05/step6-300x200.png 300w"
								data-sizes="(max-width: 751px) 100vw, 751px" /></div>
						<div class="step-item-content">
							<div class="step-item-before-title">
				...
				<div class="flex-row">
					...
					<div class="specialists-slider-right">
						<div class="specialists-slider-wrapper">
							<div class="swiper-container specialists-slider">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
									...
									<div class="swiper-slide">
										<div class="specialist-item"> <noscript><img
													src="superuploads/2021/07/sotrudnik-6.jpg" alt="Алексей Петренко"
													title="Алексей Петренко"></noscript><img class="lazyload"
												src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E'
												data-src="superuploads/2021/07/sotrudnik-6.jpg" alt="Алексей Петренко"
												title="Алексей Петренко">
						...
						<div class="swiper-button-next spec-button-next"></div>
						<div class="swiper-button-prev spec-button-prev"></div>
					</div>
				</div>
			</div>
		</section> -->
	...
	<section id="excursion">
		<div class="container">
			<div class="excursion-wrapper lazyload" data-bg="wp-content/themes/super_dom/images/excursion_bg.jpg"
				style="background-image: url(data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20500%20300%22%3E%3C/svg%3E);">
							...
							<div class="reviews-slider-track">
								...
								<div class="reviews-slide">
									<div class="review-item">
										...
										<div class="review-item-photo">
											...
											<img class="lazyload" src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E' data-src="superuploads/2021/07/otzyv-2-1.jpg" alt="Никита Сазонов" title="Никита Сазонов">
										</div>
								...
								<div class="reviews-slide">
									<div class="review-item">
										...
										<div class="review-item-photo">
											<noscript>
												<img src="superuploads/2021/07/otzyv-3.jpg" alt="Анна Петрова" title="Анна Петрова">
											</noscript>
											<img class="lazyload" src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E' data-src="superuploads/2021/07/otzyv-3.jpg" alt="Анна Петрова" title="Анна Петрова">
										</div>
										<div class="review-item-top">
								...
								<div class="reviews-slide">
									<div class="review-item">
										...
										<div class="review-item-photo">
											<noscript>
												<img src="superuploads/2021/07/otzyv-4-1.jpg" alt="Бобер Мамонов" title="Бобер Мамонов">
											</noscript>
											<img class="lazyload" src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E' data-src="superuploads/2021/07/otzyv-4-1.jpg" alt="Бобер Мамонов" title="Бобер Мамонов">
										</div>
										<div class="review-item-top">
							...
							<div class="specialists-slider-track">
								...
								<div class="specialists-slide">
									<div class="specialist-item">
										<img class="lazyload" src="superuploads/2021/07/sotrudnik-2.jpg"
											alt="Василий Ермаков">
										<div class="specialist-item-fio text-center">Василий Ермаков</div>
										<div class="specialist-item-post text-center">Генеральный директор</div>
										<ul class="specialist-item-pluses">
				...
				<div class="flex-row">
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-0"> <button class="accordion-button">Какие
									дома вы проектируете?</button></div>
					...
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-1"> <button
									class="accordion-button collapsed">Из чего складывается стоимость дома?</button>
							</div>
					...
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-2"> <button
									class="accordion-button collapsed">С чего начинается строительство
									дома?</button></div>
					...
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-3"> <button
									class="accordion-button collapsed">Актуальны ли цены на сайте?</button></div>
							<div id="faq-3" class="accordion-collapse collapse" style="display: none;;">
								<div class="accordion-body">
									<p>Мы стараемся поддерживать актуальные цены, но рынок строительных материалов
										очень быстро меняется, поэтому итоговая цена на готовый дом может отличаться
										как в большую, так и в меньшую сторону.</p>
									<p>Обратите внимание, что итоговая стоимость фиксируется в договоре и не
										меняется после начала стройки.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-4"> <button
									class="accordion-button collapsed">Какие гарантии вы даете?</button></div>
							<div id="faq-4" class="accordion-collapse collapse" style="display: none;;">
								<div class="accordion-body">
									<p>На свою работу мы даем гарантию 5 лет по договору. На используемые материалы
										гарантию дает производитель. На некоторые материалы производители дают
										бессрочную гарантию.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-5"> <button
									class="accordion-button collapsed">Какие этапы оплаты?</button></div>
							<div id="faq-5" class="accordion-collapse collapse" style="display: none;;">
								<div class="accordion-body">
									<p>Проектирование дома производится по полной предоплате.</p>
									<p>По строительству — оплата разбивается на этапы (фундамент, стены, крыша) и
										происходит за каждый этап отдельно, всю сумму за дом сразу вносить не
										обязательно.</p>
								</div>
							</div>
						</div>
					...
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-6"> <button
									class="accordion-button collapsed">В какое время года вы строите?</button></div>
							<div id="faq-6" class="accordion-collapse collapse" style="display: none;;">
								<div class="accordion-body">
									<p>Мы строим круглый год. Иногда даже предпочтительнее строить в холодное время
										года (деревянные дома из зимнего леса). Каменные дома тоже можно возводить в
										холодное время года, при использовании специальных строительных смесей. Как
										правило зимой строить выгоднее для заказчика — цены на многие стройматериалы
										ниже, чем в сезон.</p>
								</div>
							</div>
						</div>
					...
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-7"> <button
									class="accordion-button collapsed">Можно ли у вас купить готовый дом?</button>
							</div>
							<div id="faq-7" class="accordion-collapse collapse" style="display: none;;">
								<div class="accordion-body">
									<p>Да мы строим дома своими силами на продажу. Наличие, характеристики и
										расположение домов уточняйте по телефону или отправив заявку на сайте.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-8"> <button
									class="accordion-button collapsed">Можно ли заказать строительство в кредит,
									ипотеку, рассрочку?</button></div>
							<div id="faq-8" class="accordion-collapse collapse" style="display: none;;">
								<div class="accordion-body">
									<p>Мы сотрудничаем с несколькими банками и можем построить дом в ипотеку или
										кредит. О рассрочке можно договориться индивидуально.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-9"> <button
									class="accordion-button collapsed">В каких регионах вы работаете?</button></div>
							<div id="faq-9" class="accordion-collapse collapse" style="display: none;;">
								<div class="accordion-body">
									<p>Мы работаем в Одессе и по Одесской области. Так-же у нас есть партнеры по
										всей России. Если вам нужно строительство в другом городе &#8212; обратитесь
										к нам. Мы посоветуем надежную, проверенную компанию. Оставьте заявку и
					...
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-10"> <button
									class="accordion-button collapsed">Входит ли фундамент в стоимость дома на вашем
									сайте?</button></div>
							<div id="faq-10" class="accordion-collapse collapse" style="display: none;;">
								<div class="accordion-body">
									<p>Постройка фундамента не входит в стоимость комплектации т.к. заранее
										невозможно выбрать и выполнить расчет фундамента для всех типов почв,
										особенностей участка и конструктивных особенностей проектов.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="faq-item">
						<div class="accordion-item">
							<div class="accordion-header" id="faq-head-11"> <button
									class="accordion-button collapsed">Какие фундаменты вы используете?</button>
							</div>
							<div id="faq-11" class="accordion-collapse collapse" style="display: none;;">
								<div class="accordion-body">
									<p>Для разных типов домов используются разные типы фундамента:</p>
									<ul>
										<li>Свайно-винтовой — для легких каркасных и деревянных домов.</li>
										<li>Свайно-забивной — для каркасных и деревянных домов, в зависимости от
											почвы.</li>
										<li>УШП — для домов из газо-пеноблоков и в целом для средне-высокого
											ценового сегмента.</li>
										<li>Ленточный — для всех типов домов, в зависимости от почвы.</li>
										<li>Свайно-ростверковый — в зависимости от типа дома и грунта на участке.
										</li>
									</ul>
								</div>
							</div>
	...
	<section id="smeta-form">
		<div class="container">
			<div class="smeta-box lazyload" data-bg="wp-content/themes/super_dom/images/smeta-bg.jpg"
				style="background-image: url(data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20500%20300%22%3E%3C/svg%3E);">
				<div class="flex-row">
							...
							<div class="form-group-socials">
								...
								<div class="form-group form-group-socials-labels"> <input type="radio"
										...
										class="form-group-social-label" for="viber-smeta-form"> <noscript><img
												src="wp-content/themes/super_dom/icons/label-viber.png" alt="Viber"
												title="Viber"></noscript><img class="lazyload"
											src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E'
											data-src="wp-content/themes/super_dom/icons/label-viber.png" alt="Viber"
			...
			<div class="flex-row">
				...
				<div class="contacts-col contacts-col-data">
					...
					<div class="contacts-email-box"> <noscript><img
								src="wp-content/themes/super_dom/icons/label-email-min.png"></noscript><img
							class="lazyload"
							src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20210%20140%22%3E%3C/svg%3E'
							data-src="wp-content/themes/super_dom/icons/label-email-min.png">
