...
<head>
	...
	<!-- <link
		...
		id="font-awesome"
		href="wp-content/cache/autoptimize/css/index.css"
		media="all"> -->


	<!-- Library -->
	<!-- <link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" id="fancybox"
		href="wp-content/themes/super_dom/css/jquery.fancybox.min.css" media="all"> -->
		...
		<header class="hidden-print">
			<div class="container">
				<div class="header-top-wrap">
					...
					<div class="text-center header-button-wrapper"> <a href="#modal" class="button green header-button">Отправить проект на просчет</a></div>
												...
												<li id="menu-item-379"
													...
													<ul class="sub-menu">
														...
														<li id="menu-item-471"
															...
															<a href="/proekty/taunhaus/">Таунхаус</a>
														</li>
													</ul>
												</li>
												<li id="menu-item-413"
